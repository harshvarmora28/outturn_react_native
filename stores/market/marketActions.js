...
export function getHoldings(holdings = [], currency = "inr", orderBy = "market_cap_desc", sparkline = true, priceChangePerc = "7d", perPage = 10, page = 1){
    return dispatch => {
        ...
        return axios({
            ...
            if(response.state == 200){
                ...
                let myHoldings = response.data.map((item) => {
                    ...
                    // Price of the current coin from 7 days ago
...
export function getCoinMarket(currency = "inr", orderBy = "market_cap_desc", sparkline = true, priceChangePerc = "7d", perPage = 10, page = 1) {
